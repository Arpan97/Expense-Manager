...
export const category = [
    ...
    {id:14, category:'Recharge', type:'Expense'},
    {id:15, category:'Food', type:'Expense'},
    {id:16, category:'EMI', type:'Expense'},
    {id:17, category:'Family', type:'Expense'},
    {id:18, category:'Rent', type:'Expense'},
    {id:19, category:'Health', type:'Expense'},
    {id:20, category:'Loan', type:'Expense'},
    {id:21, category:'Credit Card', type:'Expense'},
    {id:22, category:'Taxes', type:'Expense'},
    {id:23, category:'Friends', type:'Expense'},
    {id:24, category:'Investment', type:'Expense'}
