...
import {change_lang, change_theme} from '../../redux/Action/Action';
    ...
    <View style={styles.container}>
      <View style={styles.header_container}>
        <TouchableOpacity onPress={() => navigation.openDrawer()}>
          <Image
            source={nightMode == true ? Images.menu_white : Images.menu}
        ...
        <View style={{marginLeft: vw(5)}}>
          <CustomText
            title={'Profile'}
            isBold
            style={[styles.nightTxt, {fontSize: 16}]}
          />
        </View>
      </View>
      {/* image view  */}
      <View style={{flexDirection: 'row'}}>
        <View
          ...
          <Image
            source={
              props?.user?.image ? {uri: props?.user?.image} : Images.user
            }
        ...
        <View style={{marginTop: vh(7), marginLeft: vw(7)}}>
          <CustomText
            ...
            isBold
            style={[styles.nightTxt, {fontSize: 15}]}
          />
          <CustomText
            title={
              props?.user?.mobile == '' ? '**********' : props?.user?.mobile
            }
            isBold
            style={[styles.nightTxt, {fontSize: 13}]}
          />
          <CustomText
            title={
              props?.user?.mail == '' ? '******@*****.com' : props?.user?.mail
            }
            isBold
            style={[styles.nightTxt, {fontSize: 13}]}
          />
      ...
      <View>
        <TouchableOpacity
          activeOpacity={0.6}
          onPress={() =>
            navigation.navigate('EditProfile', {data: props?.user})
          }
          style={{
            backgroundColor: Colors.white,
            width: '90%',
          ...
          <View
            ...
            <View>
              ...
              <CustomText
                title={'Update and modify your profile'}
                style={{fontSize: 12}}
                isRegular
              />
            </View>
      ...
      <View
        ...
        <Image
          source={Images.night_mode}
          style={{height: 20, width: 20, marginRight: vh(2)}}
        />
        <CustomText title={'Night Mode'} />
        <TouchableOpacity
          onPress={() => onChangeTheme()}
          style={{position: 'absolute', right: vw(3), top: vh(1.6)}}>
          <Image
            source={nightMode == false ? Images.switch_off : Images.switch_on}
      ...
      {/* pdf generate */}
      <TouchableOpacity
        onPress={() => navigation.navigate('CustomBill')}
        activeOpacity={0.6}
        style={{
          backgroundColor: Colors.white,
          width: '90%',
