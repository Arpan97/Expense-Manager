  ...
  return (
    <View style={{flex:1, backgroundColor: nightMode == true ? Colors.black : Colors.backgroundColor}}>
      ...
      <View style={{width:'90%', alignSelf:'center'}}>
            <View>
                <CustomText title={'Card Holder Name'} style={{fontSize:12, color: nightMode == true ? Colors.white : Colors.textColor}} isBold />
            </View>
            <View style={{marginTop:vh(0.6)}}>
                <TextInput placeholder='Enter card holder name...' value={userName} onChangeText={(txt)=>setUserName(txt)} style={{borderBottomWidth:0.3, color:Colors.black, fontSize:12, backgroundColor: nightMode == true ? Colors.white : Colors.white, borderRadius:10}} />
            </View>
        </View>
        <View style={{width:'90%', alignSelf:'center', marginTop:vh(2)}}>
            <View>
                <CustomText title={'Account Number'} style={{fontSize:12, color: nightMode == true ? Colors.white : Colors.textColor}} isBold />
            </View>
            <View style={{marginTop:vh(0.6)}}>
                <TextInput placeholder='Enter account number...' value={accNo} onChangeText={(txt)=>setAccNo(txt)} style={{borderBottomWidth:0.3, color:Colors.black, fontSize:12, backgroundColor: nightMode == true ? Colors.white : Colors.white, borderRadius:10}} keyboardType='number-pad' maxLength={16} />
            </View>
        </View>
        <View style={{width:'90%', alignSelf:'center', marginTop:vh(2)}}>
            <View>
                <CustomText title={'Card Number'} style={{fontSize:12, color: nightMode == true ? Colors.white : Colors.textColor}} isBold />
            </View>
            <View style={{marginTop:vh(0.6)}}>
                <TextInput placeholder='Enter card number...' value={cardNo} onChangeText={(txt)=>setCardNo(txt)} style={{borderBottomWidth:0.3, color:Colors.black, fontSize:12, backgroundColor: nightMode == true ? Colors.white : Colors.white, borderRadius:10}} keyboardType='number-pad' maxLength={16} />
            </View>
        </View>
        <View style={{width:'90%', alignSelf:'center', marginTop:vh(2)}}>
            <View>
            ...
            <View style={{marginTop:vh(0.6)}}>
                <TextInput placeholder='Enter expiry date (Enter without special characters)' value={expiry} onChangeText={(txt)=>setExpiry(txt)} style={{borderBottomWidth:0.3, color:Colors.black, fontSize:12, backgroundColor: nightMode == true ? Colors.white : Colors.white, borderRadius:10}} maxLength={4} />
            </View>
        </View>
        <View style={{width:'90%', alignSelf:'center', marginTop:vh(2)}}>
            <View>
            ...
            <View style={{marginTop:vh(0.6)}}>
                <TextInput placeholder='Enter cvv number...' value={cvv} onChangeText={(txt)=>setCvv(txt)} style={{borderBottomWidth:0.3, color:Colors.black, fontSize:12, backgroundColor: nightMode == true ? Colors.white : Colors.white, borderRadius:10}} keyboardType='number-pad' maxLength={3} />
            </View>
        </View>
        <View style={{width:'90%', alignSelf:'center', marginTop:vh(2)}}>
            <View>
            ...
            <View style={{marginTop:vh(0.6)}}>
                <TextInput placeholder='Enter bank name...' value={name} onChangeText={(txt)=>setName(txt)} style={{borderBottomWidth:0.3, color:Colors.black, fontSize:12, backgroundColor: nightMode == true ? Colors.white : Colors.white, borderRadius:10}} />
            </View>
        </View>
        <View style={{width:'90%', alignSelf:'center', marginTop:vh(2)}}>
            <View>
                <CustomText title={'Opening Balance'} style={{fontSize:12, color: nightMode == true ? Colors.white : Colors.textColor}} isBold />
            </View>
            <View style={{marginTop:vh(0.6)}}>
                <TextInput placeholder='Enter opening balance...' keyboardType='numeric' value={openingAmt} onChangeText={(txt)=>setOpeningAmt(txt)} style={{borderBottomWidth:0.3, color:Colors.black, fontSize:12, backgroundColor: nightMode == true ? Colors.white : Colors.white, borderRadius:10}} />
            </View>
        </View>
        <View style={{marginTop:vh(2), width:'90%', alignSelf:'center'}}>
            ...
            {/* pending work */}
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{backgroundColor:Colors.backgroundColor, borderRadius:10, marginTop:vh(0.6)}} >
                {Cards?.map((item,index)=>{
                    return(
                        <TouchableOpacity onPress={()=>setCardSelect(item)} style={{borderWidth: item?.id == cardSelect?.id ? 1 : 0, marginLeft:vw(2), borderRadius: item?.id == cardSelect?.id ? 10 : 0, borderColor:item?.id == cardSelect?.id ? Colors.themeColor : null, marginTop:vw(2), paddingBottom:10 }}>
